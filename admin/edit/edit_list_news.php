...
$stmt->bindParam(':id_news', $id_home, PDO::PARAM_INT);
$stmt->execute();
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form method="POST" enctype="multipart/form-data" action="../save_edit/save_edit_news.php">
                                ...
                                <div class="row ">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name_th_news" name="name_th_news"  value="<?= htmlspecialchars($news['name_th_news'], ENT_QUOTES, 'UTF-8') ?>" >
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group ">
                                            <label for="name_en_news">ชื่อ อังกฤษ</label>
                                            <input type="text" class="form-control" id="name_en_news" name="name_en_news"  value="<?= htmlspecialchars($news['name_en_news'], ENT_QUOTES, 'UTF-8') ?>">
                                        </div>
                                    </div>
                                </div>
                                <!-- name -->
                                ...
                                <div class="row card-body">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <?php if (!empty($news['img_1_news'])): ?>
                                                <img src="../../img/news/<?php echo $news['id_news']; ?>/<?php echo $news['img_1_news']; ?>" alt="รูป1" width="100" style="padding-top: 3px;">
                                            <?php else: ?>
                                                <p>ไม่มีรูป</p>
                                            <?php endif; ?>
                                        </div>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <?php if (!empty($news['img_2_news'])): ?>
                                                <img src="../../img/news/<?php echo $news['id_news']; ?>/<?php echo $news['img_2_news']; ?>" alt="รูป2" width="100" style="padding-top: 3px;">
                                            <?php else: ?>
                                                <p>ไม่มีรูป</p>
                                            <?php endif; ?>
                                        </div>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <?php
                                            $images = json_decode($news['img_3_news'], true);
                                            if (!empty($images)) {
                                                foreach ($images as $image) {
                                                    echo '<img src="../../img/news/' . $news['id_news'] . '/' . $image . '" alt="รูป3" width="100" style="padding-top: 3px;">';
                                                }
                                            } else {
                                                echo '<p>ไม่มีรูป</p>';
                                            }
                                ...
                                <div class="row ">
                                    <div class="col form-group">
                                        ...
                                        <textarea class="form-control" name="detail_th_news" id="detail" rows="5"><?php echo $news['detail_th_news']; ?></textarea>
                                    </div>
                                    <div class="col form-group">
                                        <label for="detail_en_news">รายละเอียด อังกฤษ</label>
                                        <textarea class="form-control" name="detail_en_news" id="detail" rows="5"><?php echo $news['detail_en_news']; ?></textarea>
                                    </div>
                                </div>
                                <!-- detail -->
                               
                                <a href="../table_news.php" class="btn btn-secondary">ย้อนกลับ</a>
